...
Terminal v0.4.0 pins `6c3388c84993bf8dfd133638a7c32a37a0769e74`, the exact Fresnica Rust capability source with versioned Argon2id wallet protection and the System Authentication boundary. Active v0.5 development pins `3f17593b5425fa1df136457fbe3badbd840a931a`, adding typed Contract Address names, executable/Wasm observations, raw Wasm metadata, and versioned SEP-41 capability evidence carried through contract inspection and invocation results; write preparation rechecks executable identity before review. Native SDK v0.3.0 remains the binary SDK baseline (Native Binding API 3 / Universal SDK API 5 / Core Client API 5); Terminal consumes `fresnica-client` / `fresnica-sdk` directly without changing that published Native/UniFFI ABI.
