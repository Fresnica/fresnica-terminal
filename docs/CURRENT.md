...
- Active v0.6 composition-contract branch: `feat/terminal-v0.6-abi-composition-contract`; it pins Fresnica shared source `188fbbc6e17cd43419407bdc1c13371013e8e9dc` from `feat/rust-client-abi-composition-contract`. Earlier v0.6 checkpoints are shared `ca2893b` / Terminal `0126e85` for the semantic ABI schema, shared `da21d835` / Terminal `c6b4baf` for typed JSON composition, shared `e68c55c` / Terminal `aa18875` for UDT boundary hardening, and shared `ad759b0` / Terminal `f76041e` for corpus/value-identity hardening.
